      ...
      <section className="relative py-24 px-4 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <p className="mx-auto mb-8 max-w-2xl text-xl leading-8 text-gray-600">
            The next generation of AI assistants with advanced memory, emotional intelligence, 
            and adaptive personality. Built for meaningful conversations that evolve.
          </p>
        ...
        <div className="mx-auto max-w-6xl">
          ...
          <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-4">
            {features.map((feature, index) => (
              <Card key={index} className="border-0 bg-white/70 backdrop-blur-sm transition-all hover:bg-white/80 hover:shadow-lg">
                <CardHeader>
